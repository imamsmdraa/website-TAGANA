    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
      <div className="bg-[#044BB1] px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={onOpenInfo}
            className="bg-white text-[#044BB1] cursor-pointer hover:bg-blue-50 px-4 py-2 rounded-lg text-sm sm:text-base font-bold shadow-md transition-all duration-200 flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
